...
const CardMyFavourite = ({ i,data , handleApply, handleUnSave }) => {
    ...
    return (
        <section className="card relative">
            ...
            <div className="absolute bottom-4 right-4 space-x-5">
                ...
                <button onClick={() => handleUnSave(id,i)} className="text-sm bg-gray-100 hover:bg-blue-700 text-black py-2 px-4 border border-white-700 rounded">{isSave ?  "Bỏ lưu" : "Lưu"}</button>
            </div>
        </section>
...
export default CardMyFavourite;