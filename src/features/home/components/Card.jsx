...
const Card = ({data,role}) => {
    const {id,name,companyName, companyLogo, salary, createAt,experience ,exprires} = data;
    ...
    return (
        <section className="card">
            <Link to={role === 'employer' ? `/employeer/${id}` :`/seeker/${id}`} className='flex gap-4 flex-col sm:flex-row items-start'>
