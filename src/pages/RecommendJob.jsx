...
import { addFavourite } from 'services/be_server/api_favouriate';
import CardRecommendJob from 'features/home/components/CardRecommendJob';
import { reommmendJob } from 'services/be_server/api_job';
const RecommendJob = () => {
    ...
    const handleSave = async (id, index) => {
        await addFavourite(user.token, id)
            ...
            .catch(error => {
                toast.error("Llưu thất bại! xin thử lại", {
                    position: 'top-center',
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
    ...
    const results = jobs !== null ? jobs.map((data, i) => <CardRecommendJob key={i} data={data} handleApply={handleApply} handleUnSave={handleSave} />) : "";
    ...
    return (
        <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
            <PageHeader title={"Việc làm phù hợp"} path={"job-recommend"} />
            <div className='mt-5'>
