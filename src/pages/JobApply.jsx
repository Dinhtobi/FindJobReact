...
const JobApply = () => {
    ...
    var urlString = serverUrl + "/recruiter/my-job?isShow=false";
    ...
    return (
        <div className='max-w-full-2xl container mx-auto xl:px-24 px-24 py-8'>
            <PageHeader title="Danh sách bài tuyển dụng"  path={"cv-apply"} />
        <div className='mt-5'>
                                            ...
                                            : (<tbody>
                                                {
                                                    currentJobs.map((job, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                                {job.minSalary} Tr - {job.maxSalary} Tr VND
                                                            </td>
                                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                            ...
                                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                                <button><Link to={`/recruiter/cv-apply/${job?.id}`}>Xem</Link></button>
                                                            </td>
                                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                                <button><Link to={`/recruiter/recommend-candidate/${job?.id}`}>Xem</Link></button>
                                                            </td>
                                                        </tr>
                                                    ))
                                                }
